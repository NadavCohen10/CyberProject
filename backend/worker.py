...
# if model is None:
#     raise RuntimeError("No valid model file found. Train a model and place it at one of: " + ", ".join(MODEL_PATH))
...
#             # Imported functions + suspicious import count
#             n_imports = 0
#             suspicious_count = 0
...
#                              suspicious_count += 1
#                      except Exception:
#                          # Some import entries might not have a .name attribute
#                          continue
...
#             # Ensure feature order matches training CSV: [size, n_sections, n_imports, num_suspicious_imports, n_exports, has_sig, entropy]
